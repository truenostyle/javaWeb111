...
public class AuthTokenDao {
    ...
    public AuthToken getTokenByBearer( String bearer) {
        ...
        String sql = "SELECT BIN_TO_UUID(t.jti) AS jti, t.sub, t.iat, t.exp FROM " + dbPrefix + "auth_token " +
    ...
    public AuthToken getTokenByCredentials(String login, String password){
        ...
        String sql = "INSERT INTO " + dbPrefix + "auth_token (jti, sub, iat, exp) " +
                "VALUES( UUID_TO_BIN(?),?,?,?)";
        try(PreparedStatement prep = dbProvider.getConnection().prepareStatement( sql )) {
    ...
    public AuthToken getActiveToken(User user){
        ...
        String sql = "SELECT BIT_TO_UUID(a.jti) AS jti, a.sub, a.iat FROM " + dbPrefix + "auth_tokens a " +
    ...
    public boolean install() {
        String sql = "CREATE TABLE " + dbPrefix + "auth_token (" +
